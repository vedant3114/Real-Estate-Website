...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="100" placeholder="Enter Property Address" class="input">
      </div>
      <div class="flex">
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="address" required maxlength="50" placeholder="enter property location eg: Andheri, Mumbai, Nerul" class="input">
         </div>
         <div class="box">
