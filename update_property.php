...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="150" placeholder="enter property address" value="<?= $fetch_property['property_name']; ?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="address" required maxlength="50" placeholder="enter property location eg: andheri,mumbai" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
