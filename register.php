...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="number" placeholder="enter your number" class="box" required pattern="^\+91\d{10}$">
      <small class="form-text">Enter a 10-digit Indian contact number starting with +91, without spaces or special characters.</small>
     <div class="password-container">
            <input type="password" id="password" name="pass" placeholder="Enter Your Password" maxlength="20" required class="box">
